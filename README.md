...
* 编辑器：[Sublime Text 2] / [Atom] / [VScode] / [WebStorm] 
* 命令行：[iTerm2]
* 浏览器调试环境：[Chrome]
* 移动设备调试环境：[chrome://inspect] / [Xcode]
* 兼容性测试：[VirtualBox] + 其他虚拟机
* 版本控制工具：[Github] / [Gitlab] / [SourceTree]
* HTTP抓包及Post/Get模拟：[Charles] / [Postman]
* SQL数据库管理：[Sequel Pro]
* 设计工具：[PS]／[AI]／[Sketch]／[Zeplin]
...
##### 2.7.1.2 前端技术栈
* 前端开发：HTML5/CSS3/JavaScript/Bootstrap/Less
* 前端框架：Vue.js + Vue-router + Vue-resource + Webpack + Vuex + ES6(Vue 全家桶)
* 核心库：Vue.js
* 应用生命周期: Vuex
* 语言：ES6 && Babel
* 规划校准：ESLint
...
* Chrome 扩展 -> 可根据自己需求来添加
* Sublime Text 2 技巧  -> [ST2 资源技巧汇总]
* Atom / VScode 插件安装可根据自己喜好安装
